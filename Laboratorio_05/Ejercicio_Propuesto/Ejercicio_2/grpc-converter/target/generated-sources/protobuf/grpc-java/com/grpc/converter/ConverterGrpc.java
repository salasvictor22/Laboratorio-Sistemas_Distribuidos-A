...
public final class ConverterGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.grpc.converter.ConvertRequest,
      com.grpc.converter.ConvertResponse> getConvertMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Convert",
      requestType = com.grpc.converter.ConvertRequest.class,
      responseType = com.grpc.converter.ConvertResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.grpc.converter.ConvertRequest,
      com.grpc.converter.ConvertResponse> getConvertMethod() {
    io.grpc.MethodDescriptor<com.grpc.converter.ConvertRequest, com.grpc.converter.ConvertResponse> getConvertMethod;
      ...
      synchronized (ConverterGrpc.class) {
        if ((getConvertMethod = ConverterGrpc.getConvertMethod) == null) {
          ConverterGrpc.getConvertMethod = getConvertMethod =
              io.grpc.MethodDescriptor.<com.grpc.converter.ConvertRequest, com.grpc.converter.ConvertResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Convert"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.converter.ConvertRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.grpc.converter.ConvertResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
    ...
    /**
     */
    default void convert(com.grpc.converter.ConvertRequest request,
        io.grpc.stub.StreamObserver<com.grpc.converter.ConvertResponse> responseObserver) {
  ...
  public static final class ConverterStub
    ...
    /**
     */
    public void convert(com.grpc.converter.ConvertRequest request,
        io.grpc.stub.StreamObserver<com.grpc.converter.ConvertResponse> responseObserver) {
  ...
  public static final class ConverterBlockingStub
    ...
    /**
     */
    public com.grpc.converter.ConvertResponse convert(com.grpc.converter.ConvertRequest request) {
  ...
  public static final class ConverterFutureStub
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.grpc.converter.ConvertResponse> convert(
        com.grpc.converter.ConvertRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CONVERT:
          serviceImpl.convert((com.grpc.converter.ConvertRequest) request,
              (io.grpc.stub.StreamObserver<com.grpc.converter.ConvertResponse>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              com.grpc.converter.ConvertRequest,
              com.grpc.converter.ConvertResponse>(
  ...
  private static abstract class ConverterBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.grpc.converter.ConverterProto.getDescriptor();
    }
